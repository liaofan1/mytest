	...
	<form action="${pageContext.request.contextPath }/queryItem.do"
		...
		<table width="100%" border=1>
			...
			<c:forEach items="${itemList}" var="item" varStatus="vs">
				<tr>
					<td><input type="hidden" name="itemList[${vs.index}].id" value="${item.id}"/></td>
					...
					<td><input type="text" name="itemList[${vs.index}].createtime" value="<fmt:formatDate value="${item.createtime}"
